...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.revert_state_button = QtWidgets.QPushButton(self.centralwidget)
        self.revert_state_button.setObjectName("revert_state_button")
        self.gridLayout_2.addWidget(self.revert_state_button, 4, 0, 1, 1)
