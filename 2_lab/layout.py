...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Brez_algo_float_button = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.Brez_algo_float_button.setFont(font)
        self.Brez_algo_float_button.setObjectName("Brez_algo_float_button")
        self.Main_Vertical_Layout.addWidget(self.Brez_algo_float_button)
        self.Brez_algo_int_button = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.Brez_algo_int_button.setFont(font)
        self.Brez_algo_int_button.setObjectName("Brez_algo_int_button")
        self.Main_Vertical_Layout.addWidget(self.Brez_algo_int_button)
        self.Brez_algo_smooth_button = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(12)
        self.Brez_algo_smooth_button.setFont(font)
        self.Brez_algo_smooth_button.setObjectName("Brez_algo_smooth_button")
        self.Main_Vertical_Layout.addWidget(self.Brez_algo_smooth_button)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Brez_algo_float_button.setText(_translate("MainWindow", "Алгоритм Брезенхема"))
        self.Brez_algo_int_button.setText(_translate("MainWindow", "Алгоритм Брезенхема с целыми числами"))
        self.Brez_algo_smooth_button.setText(_translate("MainWindow", "Алгоритм Брезенхема со сглаживанием"))
